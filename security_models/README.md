...
| **Honest-path liveness / fairness policy** | Failure classes, retry restrictions, stall, and explicit abandonment are defined. Interoperable timeouts, blame, peer non-cooperation, WT failover, and SAR replacement remain undefined. |
...
| Digging | Each Boomlet samples one fresh mystery on entry, advances only from a complete current-peer ping set and safe chain view, and keeps participating after reaching. | R-03, R-05, R-09, R-13, R-25 / DG-01, DG-02, DG-24, DG-25, DG-33, DG-35 |
...
| R-13 | WT, SAR, peer availability, or fairness gaps block withdrawal or rescue acknowledgement | 12 | Gap | DG-12, DG-13, DG-14, DG-24, DG-39 | Active flow depends on one WT, one SAR per peer, and all peers. Retry restrictions are specified; timeout, blame, failover, replacement, and crash recovery are not. |
...
| R-25 | Digging-game timing, reorg recovery, or stalling edge cases | 12 | Gap | DG-01, DG-02, DG-24, DG-25, DG-33, DG-35 | Full current-peer ping sets, monotonic reach state, and continued participation by reached peers close the known acceleration and final-laggard paths. Adversarial timing, reorg recovery, and recurring-duress selection still need validation. |
...
| DG-24 | Honest-path liveness lacks interoperable timeout and fairness policy | Failure classes, retry restrictions, stalling, and explicit abandonment are defined, but peer/service progress, timeout schedules, blame, WT failover, and SAR replacement are not. | High | Partly resolved in 96734855a35db6af7c6d8be06d72d452433bbc6b; timeout and fairness policy remain open. |
| DG-25 | Freshness recovery and evidence retention are incomplete | The SPEC binds current pings to `approved_withdrawal_id`, sequence, signer, reached state, and accepted heights, and stalls on unsafe chain views. It does not define durable evidence retention or recovery after a chain-view stall. | High | Digging progression was corrected in 8ec6fdba27b0cfd045105d1defb9db20404fc4c8 and a99ea26c2f60347a3dab866f0e10d9198538f295; recovery and audit retention remain open. |
